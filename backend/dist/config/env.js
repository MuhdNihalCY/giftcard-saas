...
if (exports.env.JWT_SECRET && exports.env.JWT_SECRET.length < 32) {
    throw new Error('JWT_SECRET must be at least 32 characters long');
}
if (exports.env.JWT_REFRESH_SECRET && exports.env.JWT_REFRESH_SECRET.length < 32) {
...
if (exports.env.NODE_ENV === 'production') {
    ...
    if (!exports.env.CORS_ORIGIN || exports.env.CORS_ORIGIN === 'http://localhost:3000') {
